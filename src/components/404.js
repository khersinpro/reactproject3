...
const Error = () => {
  return (
    <div className="errorPage">
      <svg xmlns="http://www.w3.org/2000/svg" fill="white"  height='100px' viewBox="0 0 24 24">
        <path d="M16.775 16.368a1 1 0 0 1-1.55 1.264 4 4 0 0 0-6.45 0 1 1 0 1 1-1.55-1.264 6 6 0 0 1 9.55 
